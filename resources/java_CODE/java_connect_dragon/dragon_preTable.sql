...
HouseID varchar(10) NOT NULL PRIMARY KEY,
TMP_set double DEFAULT 12.0,
Intruder_Alarm boolean DEFAULT FALSE,
apiKEY varchar(20) UNIQUE NOT NULL,
Lock1 boolean DEFAULT FALSE
);

INSERT INTO System_Threshold (HouseID, apiKEY) VALUES ("1234", "IgorDumb1234");
INSERT INTO System_Threshold (HouseID, apiKEY) VALUES ("4321", "IAMapiKEY1234");
